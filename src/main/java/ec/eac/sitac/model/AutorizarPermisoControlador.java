...
public class AutorizarPermisoControlador {
	...
	public AutorizarPermisoControlador() {
		super();
	}


	public AutorizarPermisoControlador(int idPermiso, String controlador, boolean leer, boolean insertar, boolean actualizar, boolean borrar, Rol rol) {
		super();
