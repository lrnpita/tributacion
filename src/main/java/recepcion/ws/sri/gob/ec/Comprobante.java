...
public class Comprobante  implements java.io.Serializable {
    ...
    private recepcion.ws.sri.gob.ec.Mensaje[] mensajes;
    ...
    public Comprobante(
           ...
           recepcion.ws.sri.gob.ec.Mensaje[] mensajes) {
     ...
     * @return mensajes
     */
    public recepcion.ws.sri.gob.ec.Mensaje[] getMensajes() {
        return mensajes;
    }
     ...
     * @param mensajes
     */
    public void setMensajes(recepcion.ws.sri.gob.ec.Mensaje[] mensajes) {
        this.mensajes = mensajes;
    }
