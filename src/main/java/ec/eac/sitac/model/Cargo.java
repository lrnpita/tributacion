...
/**
 * Modelo correspondiente a la tabla cargo de la base de datos
 *
...
public class Cargo implements java.io.Serializable {
	...
	/**
	 * Lista de trabajadores relacionados con cargo
	 *
	 * @since 2015
	 */
	...
	public Cargo(int id, String nombre, String descripcion, Set<PersonalEmpresa> personalEmpresas) {
		this.id = id;
		this.nombre = nombre;
