...
public class RespuestaSolicitud  implements java.io.Serializable {
    ...
    private recepcion.ws.sri.gob.ec.Comprobante[] comprobantes;
    ...
    public RespuestaSolicitud(
           ...
           recepcion.ws.sri.gob.ec.Comprobante[] comprobantes) {
           this.estado = estado;
     ...
     * @return comprobantes
     */
    public recepcion.ws.sri.gob.ec.Comprobante[] getComprobantes() {
        return comprobantes;
    }
     ...
     * @param comprobantes
     */
    public void setComprobantes(recepcion.ws.sri.gob.ec.Comprobante[] comprobantes) {
        this.comprobantes = comprobantes;
    }
